...
public class Funcation_Chi {
	...
	public static List<String> calculate_chi(List<String> txtList) {  
		...
		//获取每个单词的最大chi
		String2Txt.writeFileByLines("E:\\ceping\\jieba_end_train\\feature\\max_feature.txt", maxList);
...
//				List<String> txtList=Txt2String.readFileByLines("E:\\ceping\\jieba_end_train\\df_juzhen\\juzhen.txt");
//				List<String> list=calculate_chi(txtList);	
//				String2Txt.writeFileByLines("E:\\ceping\\jieba_end_train\\feature\\feature.txt", list);
//
//		//3.每个词最大chi按从大到小排序(end_feature.txt)
//				List<String> maxList=Txt2String.readFileByLines("E:\\ceping\\jieba_end_train\\feature\\max_feature.txt");
//				List<String> list2=SortFeature(maxList);
//				String2Txt.writeFileByLines("E:\\ceping\\jieba_end_train\\feature\\end_feature.txt", list2);//最大chi排序

		//4.按chi从大到小排序词的tf矩阵(jieba_tf_feature.txt)
		List<String> endList=Txt2String.readFileByLines("E:\\ceping\\jieba_end_train\\feature\\end_feature.txt");
		//	System.out.println(endList.get(0));
		List<String> tfList=Txt2String.readFileByLines("E:\\ceping\\jieba_end_train\\df_juzhen\\juzhen.txt");	
		List<String> list=getFeatureTF(endList, tfList);
		String2Txt.writeFileByLines("E:\\ceping\\jieba_end_train\\feature_df\\feature_df.txt", list);
